...
class SkirtDetailPage extends StatelessWidget {
  const SkirtDetailPage({super.key});
    ...
    return AppBackground(
      child: Scaffold(
        ...
        body: GridView.builder(
          ...
          itemCount: etekKesimleri.length,
          itemBuilder: (context, index) {
            final item = etekKesimleri[index];
            return _SkirtCard(
              item: item,
...
class _SkirtCard extends StatelessWidget {
  final Map<String, dynamic> item;
  final VoidCallback onTap;

  const _SkirtCard({required this.item, required this.onTap});
