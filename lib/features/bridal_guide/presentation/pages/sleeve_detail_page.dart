...
class SleeveDetailPage extends StatelessWidget {
  const SleeveDetailPage({super.key});
    ...
    return AppBackground(
      child: Scaffold(
        ...
        body: GridView.builder(
          ...
          itemCount: kolModelleri.length,
          itemBuilder: (context, index) {
            final item = kolModelleri[index];
            return _SleeveCard(
              item: item,
...
class _SleeveCard extends StatelessWidget {
  ...
  const _SleeveCard({required this.item, required this.onTap});
